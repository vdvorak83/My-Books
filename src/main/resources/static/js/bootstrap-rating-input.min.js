!function (a) {
    ...
    function e(b, c) {
        if (c.inline) var d = a('<span class="rating-input" style="font-size: 30px; color: rgb(245, 166, 35)"></span>'); else var d = a('<div class="rating-input" style="font-size: 30px; color: rgb(245, 166, 35)"></div>');
    ...
    var k = a.fn.rating = function (c) {
        return this.filter("#book-rating").each(function () {
    ...
    k.Constructor = j, a(function () {
        a("input.#book-rating").each(function () {
            a(this).rating()
        })
    })
}(jQuery);
